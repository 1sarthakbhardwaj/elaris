    ...
    <main className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute top-20 left-1/4 w-[400px] h-[300px] bg-pink-200/20 rounded-full blur-[100px]" />
        </div>
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm">
            ...
            <div className="p-4 rounded-xl bg-yellow-50 border border-yellow-200 mb-4">
              <p className="text-gray-700 text-sm leading-relaxed">
                <strong className="text-yellow-600">⚠️ Important:</strong> Outputs are generated by probabilistic systems and may be incorrect, incomplete, non-unique, or unsuitable.
              </p>
            </div>
            <ul className="space-y-2">
              {[
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
                <p className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
                  <span className="text-purple-600">A.</span> Your content
                </p>
              ...
              <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
                <p className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
                  <span className="text-purple-600">B.</span> Outputs
                </p>
                <p className="text-sm text-gray-600 mb-2">
              ...
              <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
                <p className="text-sm font-semibold text-gray-900 mb-2 flex items-center gap-2">
                  <span className="text-purple-600">C.</span> Feedback
                </p>
                <p className="text-sm text-gray-600">
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm">
            ...
            <div className="p-4 rounded-xl bg-purple-50 border border-purple-200">
              <p className="text-gray-700 text-sm">
                ...
                <a href="mailto:sales@elarislabs.ai" className="text-purple-600 hover:text-purple-700 transition-colors">
                  sales@elarislabs.ai
                </a>
              </p>
            </div>
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm">
            ...
            <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
              <p className="text-base text-gray-600 leading-relaxed mb-4 uppercase text-sm tracking-wide">
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm">
            <h2 className="text-lg md:text-xl font-semibold tracking-tight mb-4 text-gray-900 flex items-center gap-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-purple-100 text-purple-600 text-sm font-bold">15</span>
              Indemnification
            </h2>
            <p className="text-base text-gray-600 leading-relaxed mb-4">
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm">
            <h2 className="text-lg md:text-xl font-semibold tracking-tight mb-4 text-gray-900 flex items-center gap-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-purple-100 text-purple-600 text-sm font-bold">16</span>
            ...
            <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
              <p className="text-sm font-semibold text-gray-900 mb-2">Dispute resolution:</p>
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm">
            <h2 className="text-lg md:text-xl font-semibold tracking-tight mb-4 text-gray-900 flex items-center gap-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-purple-100 text-purple-600 text-sm font-bold">17</span>
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm">
            <h2 className="text-lg md:text-xl font-semibold tracking-tight mb-4 text-gray-900 flex items-center gap-3">
              <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-purple-100 text-purple-600 text-sm font-bold">18</span>
              Contact
            </h2>
            <div className="p-4 rounded-xl bg-purple-50 border border-purple-200">
              <p className="text-gray-700 text-sm">
                Questions about these Terms:{' '}
                <a href="mailto:legal@elarislabs.ai" className="text-purple-600 hover:text-purple-700 transition-colors">
                  legal@elarislabs.ai
                </a>
              </p>
            </div>
