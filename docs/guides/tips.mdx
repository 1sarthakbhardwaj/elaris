...
<AccordionGroup>
  ...
  <Accordion title="Check the product map before picking a video surface" icon="map">
    ElarisLabs offers several video surfaces — URL to Video, Campaign video, Studio video nodes, and hyperlapse. Pick the right one early to avoid rework. See [Product map](/getting-started/product-map) for a decision guide.
  </Accordion>
</AccordionGroup>
