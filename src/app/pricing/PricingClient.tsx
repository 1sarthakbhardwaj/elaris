...
/* ==========================================================================
 * Pricing page — interactive client shell
 * ==========================================================================
 *
 ...
 *
 * This file is `"use client"` because the billing toggle holds state.
 * The thin server wrapper at `./page.tsx` owns SEO metadata for /pricing.
 */
