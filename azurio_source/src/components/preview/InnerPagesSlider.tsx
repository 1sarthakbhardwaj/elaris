...
const INNER_PAGES_SLIDES = [
  {
    ...
    imageAlt: "ElarisLabs Image - Services Page Link",
    imageWidth: 1000,
    imageHeight: 1413,
    label: "Services",
  },
  {
    ...
    imageAlt: "ElarisLabs Image - Pricing Page Link",
    imageWidth: 1000,
    imageHeight: 1413,
    label: "Pricing Plans",
  },
  {
    ...
    imageAlt: "ElarisLabs Image - Team Page Link",
    imageWidth: 1000,
    imageHeight: 1413,
    label: "Our Team",
  },
  {
    ...
    imageAlt: "ElarisLabs Image - About Me Page Link",
    imageWidth: 1000,
    imageHeight: 1413,
    label: "About Me",
  },
  {
    ...
    imageAlt: "ElarisLabs Image - About Us Page Link",
    imageWidth: 1000,
    imageHeight: 1413,
    label: "About Us",
  },
  {
    ...
    imageAlt: "ElarisLabs Image - 404 Error Page Link",
    imageWidth: 1000,
    imageHeight: 563,
    label: "404 Error",
  },
  {
    ...
    imageAlt: "ElarisLabs Image - FAQ Page Link",
    imageWidth: 1000,
    imageHeight: 1413,
    label: "FAQ Page",
  },
  {
    ...
    imageAlt: "ElarisLabs Image - Contact Page Link",
    imageWidth: 1000,
    imageHeight: 1413,
    label: "Contact",
  },
