              ...
              <div className="mxd-block loading-wrap">
                <div className="inner-headline fullheight">
                  <div className="inner-headline__bg">
                    ...
                    {/* <Image   alt="ElarisLabs Sample Image"    src="/img/backgrounds/1920x1280_bg01.webp" width="1920" height="1280" /> */}
                          ...
                          <CommonLoadFade index={0}>
                            <div className="inner-headline__breadcrumbs loading-fade">
                              <div className="breadcrumbs__nav permanent">
                                ...
                                <span className="current-item">The Platform </span>
                              </div>
                            </div>
                          </CommonLoadFade>
                        </div>
