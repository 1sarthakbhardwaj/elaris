                              ...
                              <div className="inner-headline__caption split-caption-title pre-form">
                                <div className="mxd-grid-item">
                                  <CommonAnimatedText
                                    ...
                                    animation="splitLinesLoad"
                                  >
                                    Tell us what you are launching and we will
                                    show you the graph that builds it.{" "}
                                    <span>
                                      Product teams, agencies and retail brands
                                      use ElarisLabs to go from a brief to a
                                      live site, a deck and a running campaign.
                                    </span>
                                  </CommonAnimatedText>
                                </div>
                              </div>
              ...
              <div className="fullwidth-text headline-email-text bottom-text-small mxd-grid-item">
                <div className="fullwidth-text__wrap">
                  <a
                    ...
                    aria-label="Send email to hello@elarislabs.ai"
                  >
                    <CommonAnimatedText
                      as="span"
