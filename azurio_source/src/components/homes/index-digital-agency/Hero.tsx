...
import HeroGravityCreatives from "@/components/animations/HeroGravityCreatives";
      ...
      <>
        <div className="mxd-section mxd-hero-section no-padding loading-wrap">
          <CommonHero3DImages className="mxd-hero-02">
            ...
            {/* finished creatives raining into the first screen */}
            <HeroGravityCreatives />
            {/* scroll images */}
            ...
            <div className="mxd-hero-02__intro">
              <CommonHero3DIntroText>
                <h1 className="medium permanent">
                  Build it. Grow it. One canvas.
                </h1>
              </CommonHero3DIntroText>
            </div>
            <div className="mxd-hero-02__outro">
              <CommonHero3DOutroText>
                <p>One brief. A live product and the engine that scales it.</p>
              </CommonHero3DOutroText>
            </div>
          </CommonHero3DImages>
        </div>
