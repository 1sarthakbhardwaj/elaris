...
export default function Footer2({ name = "ElarisLabs" }: { name?: string }) {
  return (
                ...
                <div className="col-12 col-xl-6 mxd-footer__item mxd-grid-item">
                  ...
                  >
                    <p className="footer-data">
                      <span>Copyright ElarisLabs AI. All rights reserved</span>
                    </p>
                  </CommonScrollAnimated>
                </div>
                <div className="col-12 col-xl-6 mxd-footer__item">
                    ...
                    <div className="row g-0">
                      <div className="col-12 col-xl-6 mxd-grid-item">
                        ...
                        >
                          <p className="footer-data">
                            <span>
                              The agentic business OS by&nbsp;
                              <a href="https://elarislabs.ai" target="_blank">
